  ...
  createPlayer(name, id, score = 0) {
    ...
    playerDiv.innerHTML = `
        ...
        <div class="d-flex justify-content-end gap-2 mt-2">
            <button class="btn btn-sm btn-outline-warning d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;" onclick="playerManager.resetScore('${id}')" title="Reset Score" type="reset"></button>
